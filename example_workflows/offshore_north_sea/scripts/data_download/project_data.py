...
class DownloadProjectData(luigi.Task):
    ...
    def run(self):
        ...
        ##### FIRST, we will download the GADM data ####
        logger.info("Downloading GADM data...")
        for country in countries:
            logger.info(f"Downloading GADM data for {country}...")
            download_utils.download_gadm_data(country) 


        ### Next, we download the EEZ data ###

        ### UNFORTUNATELY THIS DATA CANNOT BE AUTOMATICALLY DOWNLOADED HERE DUE TO THE NATURE OF THE DATA SOURCE

        ### PLEASE DOWNLOAD THE DATA MANUALLY FROM THE FOLLOWING LINK:
        ## https://www.marineregions.org/downloads.php
        ## Select, World EEZ v12 [Shapefile] and enter your details to download the data
        ## Extract the data into the empty directory in project_data/World_EEZ_v12_20231025
